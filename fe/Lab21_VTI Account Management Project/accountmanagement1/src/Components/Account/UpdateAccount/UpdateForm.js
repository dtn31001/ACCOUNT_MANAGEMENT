...
function UpdateForm(props) {
  ...
  useEffect(() => {
    // Tìm depID
    let depId = listDepartment.find((department) => department.name === stateAccountUpdateInfoRedux.department).id;
    // Tìm posId
    let posId = listPosition.find((position) => position.name === stateAccountUpdateInfoRedux.position).id;
